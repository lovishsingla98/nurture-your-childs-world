      ...
      <main>
        ...
        <section className="hero-veil pt-0">
          ...
          <div className="container grid gap-4 md:grid-cols-2 items-center py-10 md:py-20">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 bg-accent/10 text-sm text-foreground w-max">
                <Stars className="h-4 w-4 text-accent" /> Beta waitlist now open
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button asChild size="lg" variant="hero"><a href="#waitlist">Join the Waitlist</a></Button>
        ...
        <section id="features" className="container mt-20">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[{
              icon: <Sparkles className="text-primary" />, title: "Daily Dynamic Plans", desc: "Fresh, tailored activities every day — no scripts, only personalization."
            },{
              icon: <Brain className="text-primary" />, title: "Parent Insights", desc: "Clarity without overwhelm: strengths map, curiosity tracker, gentle tips."
            },{
              icon: <Baby className="text-primary" />, title: "Kid‑Friendly Fun", desc: "Whimsical UI, story‑led prompts, soft encouragement — never judgment."
            }].map((f, i) => (
        ...
        <section className="container mt-20">
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><ShieldCheck className="text-primary" /> Privacy first</CardTitle>
            </CardHeader>
